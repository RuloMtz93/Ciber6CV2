#Código para realizar ataque spoofing mediante scapy
#Martínez Pérez Raúl
...
print("Ataque Spoofing con Scapy \n"
      + "por Raúl Martínez Pérez")
interval = 4
ip_target = input("Ingresar dirección IP a atacar: ")
ip_gateway = input("Ingresar dirección IP de la puerta de enlace: ")
